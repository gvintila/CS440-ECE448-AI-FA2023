...
if __name__ == "__main__":
    ...
    # WORDLADDER ARGS
    parser.add_argument('--problem_type',dest="problem_type", type=str,default="GridMulti",
                        help='Which search problem (i.e., State) to solve: [GridSingle, GridMulti]')
    
    # MAZE ARGS
    parser.add_argument('--maze_file', type=str, default="data/mazes/grid_multi/cross",
                        help = 'path to maze file')
    parser.add_argument('--show_maze_vis', default = True, action = 'store_true',
